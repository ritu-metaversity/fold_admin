...
<input type="password" id="pwd" name="pwd" style={{width:'100%',textAlign:'left'}} placeholder='Transaction Code'/>

</div>

</div>
<div className="row-button">
<Button style={{background:'black',borderColor:'black'}}>Submit<MdOutlineLogin/></Button>
